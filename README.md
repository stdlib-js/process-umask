...
[test-image]: https://github.com/stdlib-js/process-umask/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/process-umask/actions/workflows/test.yml?query=branch:v0.2.1
